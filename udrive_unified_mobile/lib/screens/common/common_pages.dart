...
class _SupportScreenState extends State<SupportScreen> {
  ...
  Widget build(BuildContext context) => Column(children: [
        Expanded(child: ListView(padding: const EdgeInsets.all(18), children: [
          PremiumCard(color: AppColors.surface, child: const Row(children: [Icon(Icons.support_agent_rounded, color: AppColors.primaryDark, size: 34), SizedBox(width: 12), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('24/7 tourism support', style: TextStyle(fontWeight: FontWeight.w900)), SizedBox(height: 4), Text('Dummy chat, ticket and emergency help options are active.', style: TextStyle(color: AppColors.muted, fontSize: 12))]))])),
