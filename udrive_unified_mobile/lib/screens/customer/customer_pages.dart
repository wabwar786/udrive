...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(padding: const EdgeInsets.all(18), children: [
      PremiumCard(color: const Color(0xFF0D4337), child: Column(children: [const CircleAvatar(radius: 38, backgroundColor: Colors.white, child: Icon(Icons.person_rounded, size: 42, color: AppColors.primaryDark)), const SizedBox(height: 12), Text(controller.currentUserName, style: const TextStyle(color: Colors.white, fontSize: 19, fontWeight: FontWeight.w900)), const SizedBox(height: 4), Text(controller.currentUserPhone, style: const TextStyle(color: Colors.white70, fontSize: 11)), const SizedBox(height: 15), Row(mainAxisAlignment: MainAxisAlignment.center, children: [const StatusPill(label: 'Customer account', color: AppColors.accent), const SizedBox(width: 8), StatusPill(label: controller.currentUser?.accountStatus ?? 'Active', color: AppColors.success)])])),
      const SizedBox(height: 18),
