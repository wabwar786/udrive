...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(padding: const EdgeInsets.all(18), children: [
      PremiumCard(color: Color(0xFF0D4337), child: Column(children: [CircleAvatar(radius: 38, backgroundColor: Colors.white, child: Icon(Icons.person_rounded, size: 42, color: AppColors.primaryDark)), SizedBox(height: 12), Text(controller.currentUserName, style: TextStyle(color: Colors.white, fontSize: 19, fontWeight: FontWeight.w900)), SizedBox(height: 4), Text(controller.currentUserPhone, style: TextStyle(color: Colors.white70, fontSize: 11)), SizedBox(height: 15), Row(mainAxisAlignment: MainAxisAlignment.center, children: [StatusPill(label: 'Customer account', color: AppColors.accent), SizedBox(width: 8), StatusPill(label: controller.currentUser?.accountStatus ?? 'Active', color: AppColors.success)])])),
      const SizedBox(height: 18),
