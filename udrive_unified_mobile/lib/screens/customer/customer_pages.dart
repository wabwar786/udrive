                ...
                child: PremiumCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${MaterialLocalizations.of(context).formatFullDate(booking.departureDate)} · ${booking.departureTime.format(context)}', style: const TextStyle(color: AppColors.text, fontSize: 12)),
...
class WalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(padding: const EdgeInsets.fromLTRB(18, 4, 18, 30), children: [
      Container(padding: const EdgeInsets.all(22), decoration: BoxDecoration(borderRadius: BorderRadius.circular(28), gradient: const LinearGradient(colors: [AppColors.inkDeep, AppColors.primary])), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [const Row(children: [Icon(Icons.account_balance_wallet_rounded, color: Colors.white), Spacer(), Text('Udrive Wallet', style: TextStyle(color: AppColors.onInkMuted, fontWeight: FontWeight.w700))]), const SizedBox(height: 24), const Text('Available balance', style: TextStyle(color: AppColors.onInkMuted)), const SizedBox(height: 4), Text('PKR $balance', style: const TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.w900)), const SizedBox(height: 22), Row(children: [Expanded(child: _WalletAction(icon: Icons.add_rounded, label: context.tr('addMoney'))), const SizedBox(width: 10), Expanded(child: _WalletAction(icon: Icons.send_rounded, label: context.tr('sendMoney')))])])),
