...
class TripLocationService {
  ...
  Future<void> start(String bookingId,String status) async {_bookingId=bookingId;_status=status;_timer?.cancel();await flushQueue();const seconds=10;_timer=Timer.periodic(Duration(seconds:seconds),(_)=>capture());await capture();}
