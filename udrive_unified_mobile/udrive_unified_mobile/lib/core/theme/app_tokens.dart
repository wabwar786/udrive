...
class AppTint {
  ...
  /// "nothing available yet" card. A const value rather than
  /// `pending.withValues(alpha: …)` so it can be used inside a const
  /// BoxDecoration, which is what check_const_colours.py enforces.
  static const pendingSurface = Color(0x14F79009);
