        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              const CircleAvatar(child: Text('UK')),
            ],
          ),
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      online
                          ? DS.of(context, 'online')
                          : DS.of(context, 'offline'),
            ...
            child: const Stack(
              children: [
                ...
                Positioned(
                  right: 18,
                  top: 16,
                  child: Chip(label: Text('3 nearby requests')),
                ),
              ],
            ),
          ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              Expanded(
                child: _stat('6', 'Trips today', Icons.route_outlined),
              ),
            ],
          ),
          const SizedBox(height: 22),
